...
type InfoClient interface {
	Checks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CheckList, error)
}
...
func (c *infoClient) Checks(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CheckList, error) {
	out := new(CheckList)
	err := c.cc.Invoke(ctx, "/com.url.healthcheck.Info/Checks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InfoServer interface {
	Checks(context.Context, *Empty) (*CheckList, error)
...
func (UnimplementedInfoServer) Checks(context.Context, *Empty) (*CheckList, error) {
...
func _Info_Checks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InfoServer).Checks(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/com.url.healthcheck.Info/Checks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InfoServer).Checks(ctx, req.(*Empty))
	}
...
var Info_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "com.url.healthcheck.Info",
	HandlerType: (*InfoServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Checks",
			Handler:    _Info_Checks_Handler,
		},
	},
